    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card className="bg-muted/30 border-border/50">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm flex items-center gap-2 uppercase tracking-tighter">
              <ShieldCheck className="w-4 h-4 text-green-600" /> {t("intel.plan90Title")}
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              <div className="text-[10px] font-bold text-primary uppercase mb-1">{t("intel.days0_30")}</div>
            ...
            <div>
              <div className="text-[10px] font-bold text-primary uppercase mb-1">{t("intel.days31_60")}</div>
              <ul className="text-xs list-disc list-inside space-y-1 text-muted-foreground">
                {intel.execution_plan_90_days.days_31_60.map((task, i) => <li key={i}>{task}</li>)}
              </ul>
            </div>
            <div>
              <div className="text-[10px] font-bold text-primary uppercase mb-1">{t("intel.days61_90")}</div>
              <ul className="text-xs list-disc list-inside space-y-1 text-muted-foreground">
