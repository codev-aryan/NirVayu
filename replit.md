...
### External APIs
- **AQICN API**: Live air quality data for Delhi monitoring stations (API key stored in environment variables)
- **OpenStreetMap Overpass API**: Traffic, industrial, and construction activity data for environmental intelligence
- **Google Generative AI**: Ward-specific pollution analysis and 90-day execution plan generation (requires `GOOGLE_API_KEY`)

### Blockchain
- **Hardhat**: Local Ethereum blockchain for development/demo
- **ethers.js**: Blockchain interaction for submitting and verifying pollution reports

### Key npm Packages
- `@turf/turf`: Spatial analysis for point-in-polygon ward matching
