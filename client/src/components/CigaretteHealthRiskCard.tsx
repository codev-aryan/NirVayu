...
export function CigaretteHealthRiskCard({
  ...
  return (
    <Card className={cn("p-5 border-border/60 shadow-sm bg-card rounded-2xl space-y-4", className)}>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {/* Daily Equivalent */}
          <div className="p-3.5 rounded-xl border border-amber-200/80 dark:border-amber-900/40 bg-amber-50/50 dark:bg-amber-950/20 space-y-0.5">
            ...
            <div className="text-2xl font-black text-amber-700 dark:text-amber-400">
              {dailyCigarettes} <span className="text-xs font-semibold text-muted-foreground">cigs/day</span>
            </div>
            <p className="text-[10px] text-muted-foreground font-medium pt-0.5 leading-tight">
              {wardName ? `Breathing air in ${wardName}` : "Breathing Delhi ambient air"}
            </p>
          </div>

          {/* Weekly Exposure */}
          <div className="p-3.5 rounded-xl border border-border/60 bg-muted/20 space-y-0.5">
            <div className="text-[10px] font-extrabold text-muted-foreground uppercase tracking-wider">
              WEEKLY EXPOSURE
            </div>
            <div className="text-2xl font-bold text-foreground">
              {weeklyCigarettes} <span className="text-xs font-normal text-muted-foreground">cigarettes</span>
            </div>
            <p className="text-[10px] text-muted-foreground font-medium pt-0.5">
              7-day cumulative toxicity
            </p>
          </div>
          ...
          <div className="p-3.5 rounded-xl border border-border/60 bg-muted/20 space-y-0.5">
            ...
            <div className="text-2xl font-bold text-foreground">
              {monthlyCigarettes} <span className="text-xs font-normal text-muted-foreground">cigarettes</span>
            </div>
            <p className="text-[10px] text-muted-foreground font-medium pt-0.5">
              30-day cumulative toxicity
            </p>
          </div>
        </div>

        <div className="p-2.5 rounded-xl bg-amber-50/40 dark:bg-amber-950/20 border border-amber-200/50 text-[11px] text-muted-foreground flex items-center justify-between">
          <span className="flex items-center gap-1.5 text-amber-900 dark:text-amber-200 font-medium">
            <Info className="w-3.5 h-3.5 text-amber-600 shrink-0" />
            1 cigarette/day ≈ 22 µg/m³ PM2.5 intake (Muller & Muller, Berkeley Earth)
          </span>
          <a
